...
@permission_required('vehiculo.agregar_vehiculo')  # Asegúrate de que el permiso es correcto
...
def listar_vehiculos(request):
    ...
    return render(request, 'vehiculo/listar_vehiculos.html', {'precios': precios})
